class SVGAssets {
  ...
  static const String loginSvg = "$svgBasePath/login_screen.svg";
  static const String doctorLoginSvg = "$svgBasePath/doctor_login.svg";
  static const String patientLoginSvg = "$svgBasePath/patient_login.svg";
